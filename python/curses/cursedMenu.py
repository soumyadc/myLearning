...
class CursedMenu(object):
    ...
    def draw(self):
        ...
        self.screen.addstr(1,2, self.log, curses.A_STANDOUT) #log for this menu
...
#soumyadc : only selected by curses but not pressed enter yet
#        self.log = "selected: " + str(self.selected)
    ...
    def handle_request(self, request):
        ...
        if request is None: 
            return # Until Enter is pressed request is None
        else:
            #soumyadc
            self.log = "Select and Entered: " + str(self.selected) + " " + str(request)
...
'''demo'''
cm = CursedMenu()
cm.show(['First','2nd','#3', 'Option 4'], title='My Demo Menu', subtitle='Available Options are:')
